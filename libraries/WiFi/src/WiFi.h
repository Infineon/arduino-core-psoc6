...
#define CY_WCM_INTERFACE_TYPE_UNKNOWN (cy_wcm_interface_t)0xFF
    ...
    static void set_connect_params_sta(cy_wcm_connect_params_t* connect_params,
                                       const char* ssid,
    ...
    static void
    wcm_scan_cb(cy_wcm_scan_result_t* result_ptr, void* user_data, cy_wcm_scan_status_t status);
};
